# Generated by Powerlevel10k configuration wizard on 2022-11-08 at 18:23 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=$SECONDARY
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=$SECONDARY
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$PRIMARY
